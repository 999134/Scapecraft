...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        int quickvar2 = rand.nextInt(50) + 1;
        int quickvar3 = rand.nextInt(30) + 1;
        int quickvar4 = rand.nextInt(50) + 1;
        int quickvar5 = rand.nextInt(2) + 1;
...
if(quickvar4 <= 1){entityDropItem(new ItemStack(Item.goldNugget), 1);}
