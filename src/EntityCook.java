    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
    	...
    	if (itemstack != null && itemstack.itemID == Item.cake.itemID && !par1EntityPlayer.capabilities.isCreativeMode)
        {
            if (itemstack.stackSize-- == 1)
            {
               ...
               par1EntityPlayer.addChatMessage("\u00a7ELumbridge Cook: Thank you, I don't actually have any reward for you, but I never promised one, next time be more careful with who you help");
    		...
    		par1EntityPlayer.addChatMessage("\u00a7ELumbridge Cook: Please bring me a cake, the Duke's Birthday is soon and I can't work out how to make one on minecraft, who uses raw wheat in cooking?");
