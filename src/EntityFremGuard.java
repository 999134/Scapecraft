...
protected String getLivingSound()
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
		...
		ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EFremmick Guard: Clicking here will take you to the home of Koschei the Deathless, you will need a gold ingot to summon him and items are not lost in there, good luck");
