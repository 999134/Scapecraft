    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
    	...
    	if (itemstack != null && itemstack.itemID == mod_Flower.InvincibilityPotion.itemID)
        {
            if (itemstack.stackSize-- == 1)
            {
                ...
                par1EntityPlayer.addChatMessage("\u00a7ESir Amik Varze: Thanks for your help! Take this treasure chest as a reward.");
    		...
    		par1EntityPlayer.addChatMessage("\u00a7ESir Amik Varze: Please investisgate the Black Knights Fortress north of here, I need you to steal their invincibility potion");
