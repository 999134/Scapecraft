...
public class ItemVeracFlail extends ItemSword
{
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        chest.getItem() == mod_phat.VeracChestplate && helmet.getItem() == mod_phat.VeracHelmet)
        {
        	  ...
        	  if(!par2EntityLivingBase.isEntityUndead()){
        	par2EntityLivingBase.addPotionEffect(new PotionEffect(Potion.harm.id, 7, 0));
              return true;
             }
             else
             {
            	 par2EntityLivingBase.addPotionEffect(new PotionEffect(Potion.heal.id, 7, 0));
        	  }}
        }
